...
public class MemberController {
	...
	public String login(@RequestParam(name = "memberId") String memberId,
			@RequestParam(name = "memberPw") String memberPw, HttpSession session, RedirectAttributes reAttr,
			HttpServletResponse response) {
	 ...
	 * 
	 * @param member <- 커맨드객체
	 * @return String redirect 키워드: 리디렉션 요청 문법 : redirect:요청주소;
	 */
	...
	public String getMemberList(Model model, @RequestParam(name = "searchKey", required = false) String searchKey,
